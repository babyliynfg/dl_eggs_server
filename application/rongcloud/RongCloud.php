...
require 'RongSendRequest.php';
require 'methods/User.php';
require 'methods/Message.php';
require 'methods/Wordfilter.php';
require 'methods/Chatroom.php';
require 'methods/Group.php';
require 'methods/Push.php';
require 'methods/SMS.php';
...
class RongCloud
{
    ...
    public function __construct($appKey, $appSecret, $format = 'json') {
        $this->SendRequest = new RongSendRequest($appKey, $appSecret, $format);
    }
